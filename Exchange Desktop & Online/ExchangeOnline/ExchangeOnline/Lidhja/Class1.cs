   ...
   public class LIDHJA: IDisposable
    {
        ...
        //oni.file.osirisSoapClient F = new oni.file.osirisSoapClient();
        //public string file1(string tab, string nrrec, string filename, byte[] b)
        //{
        //    return F.FILE(tab, nrrec, filename, b);
        //}
    }//END OF CLASS
    ...
    static class OSIRISLIDHJA
    {
        ...
        public static string IPMAIL = Ipmail();
        public static string INIPATH = Inipath();
        public static string MESAGEPATH = MesagePath();
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["link1"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["link2"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["link3"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["link4"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["link5"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        private static string MesagePath()
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["messagepath"];
            if (ret == null)
                ret = "";
            return ret;
        }

        private static string Ipmail()
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["ipmail"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["password"];
            if (ret == null)
                ret = "";
            return ret;
        }
        ...
        {
            string ret = "";
            ret = ConfigurationManager.AppSettings["email"];
            if (ret == null)
                ret = "";
            return ret;
        }
